		...
		$universal_user_id = $_SESSION['user_id'];
			...
			$post_title    =  $post_main_img    = $post_content_body    = $post_quote = $post_content_cont = ""; 
				...
				if(!empty($_GET['id']))
				{
					...
					$result = mysqli_query($conn,"SELECT * FROM blog WHERE id=$post_id_of_post"); 
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST") 
		{
			...
			$post_content_cont   =  $_REQUEST['post_content_cont'];
				...
				$date_updated = date ("F jS, Y");
		     	$query = "UPDATE blog SET post_title='$post_title',post_main_img='$post_main_img',post_content_body='$post_content_body',post_quote='$post_quote',post_content_cont='$post_content_cont',date_updated='$date_updated' 
